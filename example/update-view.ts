import { GlasnosticConsole } from '../src/glasnostic-api';
...
(async () => {
    ...
    const updatedView = await api.updateView(environments[1].key, view.id as string, 'Updated Name', undefined, undefined, undefined);
